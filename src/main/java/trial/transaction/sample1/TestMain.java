...
import trial.transaction.sample1.iml.etl.ETLTransactionGenerator;
...
public class TestMain {
	...
	public void testExecuteNewTransaction(){
		// 1. Get a Transaction 
		Transaction etlTransaction = new ETLTransactionGenerator().generateTransaction();
		
		// 2. Get a TransactionManager
		TransactionManager etlTransactionManager = new ETLTransactionManager(etlTransaction, new ZookeeperTransactionManagerLogger());
