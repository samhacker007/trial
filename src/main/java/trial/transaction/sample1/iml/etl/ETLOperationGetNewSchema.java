...
public class ETLOperationGetNewSchema extends Operation {

	public ETLOperationGetNewSchema() {
		super(ETLOperations.GET_NEW_SCHEMA.getName());
	}

	static private Logger log = LoggerFactory.getLogger(ETLOperationGetNewSchema.class);
